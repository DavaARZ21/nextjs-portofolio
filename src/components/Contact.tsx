            ...
            <div className="flex justify-center items-center">
                <ul className="space-y-4">
                    <li className="flex items-center">
                        ...
                        <p className="text-xl">+62 852 1212 0502</p>
                    </li>
                    <li className="flex items-center">
                        <Image src={mail} alt="mail" className="h-[110px] w-auto mr-6"/>
                        <p className="text-xl">davaarz21@gmail.com</p>
                    </li>
                </ul>
            </div>

            <div className="bg-white/10 p-6 rounded-xl max-w-[550px]">
                <h2 className="text-5xl font-bold text-orange-400 mb-4">Connect With Me</h2>
                <p className="text-white/70 mb-6">Send me a message and lets schedule a call!</p>
                <form className="space-y-4" action="https://getform.io/f/bnllnxeb" method="POST">
