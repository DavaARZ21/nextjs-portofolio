...
const projects = [
    {
        ...
        desc: "Project yang akan terus saya update, tidak hanya itu project ini akan saya selalu prioritas dimasa kini dan dimasa depan. Akan saya update setiap project dan pengalaman saya.",
        devstack: "React, Node.js, MongoDB, Express",
        link: "#",
        git: "#",
        src: proj4
    },
    {
        ...
        desc: "Project pertama saya, saya banyak dapat pengalaman dari project ini karena ketika saya mengerjakan Website ini terdapat banyak bug.",
        devstack: "PHP, HTML, CSS, JS, MysqlDB",
        link: "#",
        git: "#",
        src: proj2
    },
    {
        title: "RFID Doorlock Access",
        desc: "Project yang akan terus saya update, tidak hanya itu project ini akan saya selalu prioritas dimasa kini dan dimasa depan. Akan saya update setiap project dan pengalaman saya.",
        devstack: "React, Node.js, MongoDB, Express",
        link: "#",
        git: "#",
...
const Portofolio = () => {
    return (
        <div className="text-white bg-gradient-to-b from-black to-[#381a5f] py-18 mt-52" id="portofolio">
